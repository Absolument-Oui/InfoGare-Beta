            ...
            get(trains).then(departs => {
                departs.forEach(train => {
                    if (train.child('hourdepart').val()) {
                        ...
                        if (i < 2) {
                            elements.push(<TwoRowDepart key={train.id} type={train.child('type').val()} typename={train.child('typename').val()} number={train.child('number').val()} timing={timing} time={train.child('hourdepart').val()} track={train.child('voie').val()} retard={train.child('retardtime').val()} gare={train.child('destination').val()} gares={train.child('gares').val()} />);
                        } else if (i > 2 && i < 8) {
                            elements.push(<OneRowDepart key={train.id} type={train.child('type').val()} typename={train.child('typename').val()} number={train.child('number').val()} timing={timing} time={train.child('hourdepart').val()} track={train.child('voie').val()} retard={train.child('retardtime').val()} gare={train.child('destination').val()} />);
                        }
                        i++;
                    }
                });
