        ...
        return (
            <BrowserRouter>
                <Routes>
                    ...
                    <Route path="/gare/AFL">
                        <Route path="*" element={<GareAFL id={window.location.pathname.split('/')[2]} />} />
                        <Route path=":id/departs" element={<DepartsAFLPage id={window.location.pathname.split('/')[2]} />} />
                        <Route path=":id/arrives" element={<ArrivesAFLPage id={window.location.pathname.split('/')[2]} />} />
                    </Route>
                    <Route path="/gare/RER">
